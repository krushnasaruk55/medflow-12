...
// ========== GLOBAL NAVIGATION & LOGOUT HANDLING ==========
document.addEventListener('DOMContentLoaded', () => {
    document.body.addEventListener('click', (e) => {
        // Find if the clicked element or its parent is a Home link
        const link = e.target.closest('a[href="index.html"]') || e.target.closest('a[data-i18n="nav.home"]');
        ...
        if (link) {
            ...
            if (isAuthenticated) {
                ...
                showModal(
                    'Logout Warning',
                    'Going to the home page will log you out of your current session. Are you sure you want to continue?',
                    () => {
                        // On confirm, clear session and redirect
